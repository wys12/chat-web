...
public class JsonUtil {
	 ...
	 */  
	 static {   
		...
		DateMorpher dm = new DateMorpher(new String[] { Format.DATE_FORMAT.YYYY_MM_DD,
				Format.DATE_FORMAT.YYYY_MM_DD_HH_MM_ss, Format.DATE_FORMAT.HH_MM_ss, Format.DATE_FORMAT.YYYYMMDD,
				Format.DATE_FORMAT.YYYYMMDDHHMMSS, Format.DATE_FORMAT.HHMMss });
	 ...
	 public static String getJsonStr(Object obj) {   
		 ...
		 jsonCfg.registerJsonValueProcessor(java.util.Date.class,   
				 new JsonDateValueProcessor(Format.DATE_FORMAT.YYYY_MM_DD_HH_MM_ss));
		 if (obj == null) {   
			 return "{}";   
		 }   
	 ...
	 static class JsonDateValueProcessor implements JsonValueProcessor {
		 ...
		 private String format = Format.DATE_FORMAT.YYYY_MM_DD_HH_MM_ss;
