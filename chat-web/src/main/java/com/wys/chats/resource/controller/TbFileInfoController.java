...
public class TbFileInfoController {
    ...
    */
    ...
    @ResponseBody
    public Object insert(@RequestBody TbFileInfo tbFileInfo){
    	try {
    		int result = tbFileInfoService.insert(tbFileInfo);
    ...
    */
    ...
    public Object delete(int id){
    	try {
	    	int result =  tbFileInfoService.delete(id);
			return result  > 0 ? new Response(SystemCode.code_1000, result) : new Response(SystemCode.code_1001, null);
   		}catch (Exception e) {
			SysLog.error("删除:---"+e);
			return new Response(SystemCode.code_1002, null);
    ...
    */
    ...
    @ResponseBody
    public Object update(@RequestBody TbFileInfo tbFileInfo){
        try {
	        int result = tbFileInfoService.update(tbFileInfo);
			return result  > 0 ? new Response(SystemCode.code_1000, result) : new Response(SystemCode.code_1001, null);
    	} catch (Exception e) {
			SysLog.error("更新:---"+e);
			return new Response(SystemCode.code_1002, null);
    ...
    */
    @RequestMapping("/load")
    @ResponseBody
    public Object load(@RequestBody TbFileInfo tbFileInfo){
        try {
	        TbFileInfo result = tbFileInfoService.load(tbFileInfo);
    ...
    */
    ...
    public Object pageList(@RequestBody Request request) {
   		try {
	   		PageBean pb = tbFileInfoService.pageList(request);
