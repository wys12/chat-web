...
import com.wys.chats.resource.dao.TbIconInfoDao;
...
*/
@Service
public class TbIconInfoServiceImpl implements TbIconInfoService {

	@Resource
	private TbIconInfoDao tbIconInfoDao;
    ...
    */
	...
	public int insert(TbIconInfo tbIconInfo) {
		try {
	        ...
	        return tbIconInfoDao.insert(tbIconInfo);
		} catch (Exception e) {
	...
	*/
	...
	public int delete(int id) {
		try {
			return tbIconInfoDao.delete(id);
		} catch (Exception e) {
	...
	*/
	...
	public int update(TbIconInfo tbIconInfo) {
		try {
			return tbIconInfoDao.update(tbIconInfo);
		} catch (Exception e) {
	...
	*/
	...
	public TbIconInfo load(TbIconInfo tbIconInfo) {
		try {
			return tbIconInfoDao.load(tbIconInfo);
		} catch (Exception e) {
	...
	*/
	...
	public PageBean pageList(Request request) {
		...
		try {
			...
			return PageDaoHelper.search(tbIconInfoDao, paramMap, request.getCurrPage(), request.getPageSize());
		} catch (Exception e) {
